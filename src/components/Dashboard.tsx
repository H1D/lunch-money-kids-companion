    ...
    return (
      <div className="min-h-screen bg-slate-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-white/60">Loading your money...</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
        <div className="text-center">
          ...
          <p className="text-white/60 mb-4">Couldn't load your money buckets</p>
          <button
  ...
  return (
    <div className="min-h-screen bg-slate-900 pb-8">
      ...
      <header className="px-4 pt-12 pb-6">
        <h1
          className="text-2xl font-bold text-white text-center cursor-pointer select-none"
        ...
        >
          ...
          {showAddGoal ? (
            ...
            <button
              ...
              className="w-full mt-3 py-2 rounded-xl bg-white/10 text-white/80 text-sm font-medium hover:bg-white/20 transition-colors"
            >
              + Add Goal
            </button>
          )}
      ...
      {/* Secret tap indicator (for debugging, hidden in production) */}
      {secretTapCount > 0 && secretTapCount < 5 && (
        <div className="fixed bottom-4 left-1/2 -translate-x-1/2 bg-white/10 px-3 py-1 rounded-full">
          <span className="text-xs text-white/50">{5 - secretTapCount} more taps</span>
        </div>
      )}
    </div>
  )
